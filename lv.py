...
# --- Sidebar ---
with st.sidebar:
    st.image("https://placehold.co/400x100/004225/FFFFFF?text=Lee+Valley+GC", use_column_width=True)
    st.title("📒 MAI Recap")
    if st.button("About this App", key="about_button_sidebar"):
        st.sidebar.info(
            "**MAI Recap** helps generate meeting minutes for the Lee Valley Golf Club committee. "
    ...
    st.markdown("---")
st.markdown("Version: 2.0.1 (LVGC)")
